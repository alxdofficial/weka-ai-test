...
class MyModelTest {
    ...
    void test2() throws Exception {
        MLAlgorithm mla = new MLAlgorithm();
        EntryC e1 = new EntryC("1","item 1", "beige", "long", "thin", "mid", "low", "no",
                1, "box", "stretch", "no", "cotton", "loose", "grid",
                "high");
        EntryC e2 = new EntryC("2","item2","red", "short", "thick", "high", "high", "yes",
                1, "box", "stiff", "yes", "wool", "tight", "solid",
                "high");
        EntryC e3 = new EntryC("3","item3","red", "short", "mid", "low", "high", "no",
                1, "flowy", "mid", "yes", "synthetic", "mid", "lines",
                "high");
        EntryC e4 = new EntryC("4","item4","blue", "long", "thick", "low", "high", "yes",
                1, "flowy", "stiff", "yes", "denim", "loose", "solid",
                "low");
        List<EntryC> loe = new ArrayList<>();
        loe.add(e1);
        loe.add(e2);
        loe.add(e3);
        loe.add(e4);
